...
enterIcon = ''
...
Label(mainFrame, text="Εισαγωγή Email:", font=("Arial", 12), bg='lightgrey').pack(pady=(25, 0))
...
Label(mainFrame, text="Εισαγωγή Κύριου Κωδικού:", font=("Arial", 12), bg='lightgrey').pack(pady=(20,0))
...
enterIcon = PhotoImage(data=enterIcon)
okBtn = Button(mainFrame, borderwidth=1, text="Είσοδος", image=enterIcon, compound= LEFT, width=120)
okBtn.pack(pady="15")
